...
public class UserDetailsServiceImplementation implements UserDetailsService {
	...
	// Return a list of authorities/permissions for a specific user. For example, our clients
	// can be 'user', 'admin', or both. For Spring Security to implement authorization, we must
	// get the name of the possible roles for the current user from our database and create a new
	// `SimpleGrantedAuthority' object with those roles.
